...
#####################################################################
#           modifications for Homework Problem 4.57 start           #
#####################################################################
word e_valA = [
...
#####################################################################
#           modifications for Homework Problem 4.57 end             #
#####################################################################
...
bool F_stall =
	...
	(
		...
		# solved by load forwarding
		!(
			# a store instruction
			D_icode in { IRMMOVQ, IPUSHQ }	&&

			# valA is needed in memory stage
			E_dstM == d_srcA		&&

			# valB is needed in execute stage
			E_dstM != d_srcB
		)
	) ||
