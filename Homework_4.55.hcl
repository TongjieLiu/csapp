...
#####################################################################
#           modifications for Homework Problem 4.55 start           #
#####################################################################
...
#####################################################################
#           modifications for Homework Problem 4.55 end             #
#####################################################################
...
word f_predPC = [
	...
	1 : f_valP; # conditional jump is included here
];
#####################################################################
#           modifications for Homework Problem 4.55 end             #
#####################################################################
...
#           modifications for Homework Problem 4.55 start           #
#####################################################################
#	valC is needed in memory stage as the jump target, which is part
# of the mechanism of correcting mispredicted branches.
word e_valA = [
	#	Unconditional jump doesn't use M_valA in the memory stage,
	# therefore we don't have to distinguish conditional jumps from
	# unconditional jumps.
	E_icode == IJXX: E_valC;
	1: E_valA;
];
