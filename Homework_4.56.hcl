...
#####################################################################
#           modifications for Homework Problem 4.56 start           #
#####################################################################
## What address should instruction be fetched at
word f_pc = [
	# Mispredicted branch.  Fetch at incremented PC
	#	1. forward conditional branch
	M_icode == IJXX		&&
	M_ifun != UNCOND	&&
	M_valE >= M_valA	&&
	M_Cnd				: M_valE;
	#	2. backward conditional branch
	M_icode == IJXX		&&
	M_ifun != UNCOND	&&
	M_valE < M_valA		&&
	!M_Cnd				: M_valA;
...
#####################################################################
#           modifications for Homework Problem 4.56 end             #
#####################################################################
...
word f_predPC = [
	...
	1 : f_valP; # forward conditional branch is included here
];
#####################################################################
#           modifications for Homework Problem 4.56 end             #
#####################################################################
...
#	Conditional jump does not compute or use valE. Based on this,
# there is a simple method to bring valC to the memory stage without
# losing valP. And that is to make ALU compute valE = valC + 0 = valC.
#
# 	Note that unconditional jump does not compute or use valE either.
# For this very reason, the method we use does not affect it.
